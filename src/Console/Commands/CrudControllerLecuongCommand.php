...
class CrudControllerLecuongCommand extends GeneratorCommand
{
    /**
     ...
     * @var string
     */
    protected $name = 'lecuong:crud-controller';
     ...
     * @var string
     */
    protected $signature = 'lecuong:crud-controller {name}';
     ...
     * @var string
     */
    protected $description = 'Generate a Lecuong CRUD controller';
