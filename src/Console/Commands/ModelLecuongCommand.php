...
class ModelLecuongCommand extends GeneratorCommand
{
    /**
     ...
     * @var string
     */
    protected $signature = 'lecuong:model {name} {--softdelete}';
     ...
     * @var string
     */
    protected $description = 'Generate a lecuong templated model';
