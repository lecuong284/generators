...
class CrudModelLecuongCommand extends GeneratorCommand
{
    /**
     ...
     * @var string
     */
    protected $name = 'lecuong:crud-model';
     ...
     * @var string
     */
    protected $signature = 'lecuong:crud-model {name}';
     ...
     * @var string
     */
    protected $description = 'Generate a Lecuong CRUD model';
